...
export const SelectInput = ({ title, selectData, handleChangeSelectValue, style = {}, EventType, disabled, className, type, Ev, placeholder }) => {
                ...
                label="Age">
                  ...
                  selectData.map((i, item) => (
                    <MenuItem key={item} value={
                       type === 'timezone' ? i?.value : i }>
                        {
                          type === 'timezone' ? i?.text :
                  ...
                  {/*{EventType && <MenuItem value={EventType}>{EventType}</MenuItem>}*/}
              </Select>
          </FormControl>
      </div>
    );
