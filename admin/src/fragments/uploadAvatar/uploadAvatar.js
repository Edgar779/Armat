            ...
            <div>
                <UserAvatar
                    ...
                    image={type === 'organization' ?
                        this.state.croppedImg : this.state.croppedImg ? this.state.croppedImg :
                            this.props.MyProfile?.avatar?.url ? this.props.MyProfile?.avatar?.url : ''
                    }
