...
export const SubscribeOrganizers = ({ creators, handleFilterEvents }) => {
            ...
            <Box>
                <Box className={classes.checkCont}>
                    <FormGroup column>
                        <FormControlLabel
                            control={
                                <Checkbox checked={state === 'All'} onChange={() => handleChange('All')} name="checkedB" color="primary" />
                            }
                            label="All"
                        />
                        {creatorsNameList &&
...
export default SubscribeOrganizers;
