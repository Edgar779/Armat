...
export const ProfilePassword = ({}) => {
    ...
    const loader = FindLoad('EDIT_MY_PASSWORD');
    const success = FindSuccess('EDIT_MY_PASSWORD');
    const backError = FindError('EDIT_MY_PASSWORD');
    ...
    const handleChangeInputs = (e) => {
        setInputs(
            ...
            errText && dispatch(httpRequestsOnErrorsActions.removeError('EDIT_MY_PASSWORD'))
        );
    };
