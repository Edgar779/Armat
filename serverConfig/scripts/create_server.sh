...
sudo certbot --nginx -d armat.eachbase.com # test certificates
sudo certbot --nginx -d staging.armat.org # Staging certificates
sudo certbot --nginx -d armat.org -d www.explainitdoctarmatorly.org # live certificates
